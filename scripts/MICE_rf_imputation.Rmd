...
The proportion for an imputed dataset that is nearer to it is 0.575 and corresponds to the 3rd and 12th datasets.

We will compare the 3rd imputed dataset with similar proportion's logistic regression imputed dataset.

```{r}
write_delim(complete(imp_rrt, 3), "../data/RF_IMPUTED_DATA.csv", delim=";")
```
