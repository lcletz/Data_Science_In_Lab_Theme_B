...
The density plot has distinct curves but the overall trend seems to follow the observed data trend.
...
write_delim(data, "../data/MICE_LOGREG_IMPUTED_TABLE.csv", delim = ';')
```


```{r}
# mice_class %>% complet() == complete(mice_class, 1)
```
